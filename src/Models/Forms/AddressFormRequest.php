    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['morph_type']) && isset($data['morph_id'])) {
                if ( config('wk-morph-address.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['morph_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-morph-address.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['morph_type'] == config('wk-core.class.group.group') ) {
                ...
                } elseif ( config('wk-morph-address.onoff.account') && !empty(config('wk-core.class.account.profile')) && $data['morph_type'] == config('wk-core.class.account.profile') ) {
